...
CivilExtension.prototype.load = function () {
  ...
  createUI = function () {
    ...
    button1.onClick = function (e) {
      if (_panel == null) {
        _panel = new CivilPanel(_viewer, _viewer.container, 'civilExtensionPanel', 'Check Alignments', { guid: _panelGuid });
      }
...
function CivilPanel(viewer, container, id, title, options) {
  this.viewer = viewer;
  ...
  ul.id = options.guid + 'ul'
  ul.className = 'list-group';
  div.appendChild(ul);
}
CivilPanel.prototype = Object.create(Autodesk.Viewing.UI.DockingPanel.prototype);
CivilPanel.prototype.constructor = CivilPanel;